...
static void mergeSubarrays(int array[], int leftIndex, int middleIndex, int rightIndex)
{
...
static void mergeSort(int array[], int leftIndexOfSubarray, int rightIndexOfSubarray)
{
